...
// เสียงเอฟเฟกต์อยู่ใน public/images/sounds เสมอ ไม่ตาม ROV_USER_MEDIA_DIR
//
// ต่างจากโลโก้ทีมกับภาพพื้นหลัง ซึ่งผู้ใช้อัปโหลดผ่านหน้าเว็บ จึงต้องเขียนลงที่ที่เขียนได้
// เสียงเป็นไฟล์ที่เอามาวางเองในโฟลเดอร์ และผู้ใช้ตั้งใจให้มันอยู่ในโฟลเดอร์ของโปรเจกต์
// ชุดเดียวกับตัวแอพ จะได้ติดไปกับตัวติดตั้งและไม่ต้องไปวางใหม่ทุกเครื่อง
//
// ตอนแพ็กเป็น .exe โฟลเดอร์นี้ต้องถูกกันไว้ไม่ให้เข้า app.asar (ดู asarUnpack ใน
// package.json) ไม่งั้นมันจะกลายเป็นส่วนหนึ่งของไฟล์เดียว เปิดโฟลเดอร์ไม่ได้
// และผู้ใช้จะเอาไฟล์เสียงของตัวเองไปวางเพิ่มไม่ได้เลย
//
